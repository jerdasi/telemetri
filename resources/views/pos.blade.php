...
@section("title", "Konfigurasi Pos")

@section("content")
    <div class="container-fluid">
        <h3 class="fw-bolder pb-2">Konfigurasi Pos</h3>
            ...
            <div class="card-body">
                ...
                >
                    <div class="mb-3 mb-sm-0">
                        <h5 class="card-title fw-semibold">Daftar Pos</h5>
                    </div>
                </div>
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                        <thead class="text-dark fs-4 bg-primary border-bottom">
                            <tr>
                                ...
                                <th class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">Nama Pos</h6>
                                </th>
                                <th class="border-bottom-0">
                            ...
                            @foreach ($list_pos as $item)
                                <tr>
                                    ...
                                    >
                                        ...
                                        <form
                                            action="{{ route("pos.destroy", $item->id) }}"
                                            method="post"
                                        >
                                            @csrf
                                            @method("delete")
