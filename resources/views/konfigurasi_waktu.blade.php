...
@section("title", "Konfigurasi Waktu")

@section("content")
    <div class="container-fluid">
        <h3 class="fw-bolder pb-2">Konfigurasi Waktu</h3>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                            @foreach ($list_konfigurasi_waktu as $item)
                                <tr>
                                    ...
                                    >
                                        <a
                                            ...
                                            href="{{ route("konfigurasi-waktu.edit", $item->id) }}"
                                        >
                                            <i
                                        ...
                                        <form
                                            action="{{ route("konfigurasi-waktu.destroy", $item->id) }}"
                                            method="post"
                                        >
                                            @csrf
                                            @method("delete")
                    ...
                    @if (count($list_konfigurasi_waktu) > 5)
                        <nav
