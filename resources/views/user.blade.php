...
@section("title", "Konfigurasi User")

@section("content")
    <div class="container-fluid">
        <h3 class="fw-bolder pb-2">Konfigurasi User</h3>
        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table
                        class="table text-nowrap mb-0 align-middle table-striped"
                    >
                        ...
                        <tbody>
                            @foreach ($list_user as $item)
                                <tr>
                                    ...
                                    <td class="border-bottom-0">
                                        <h6
                                            class="fw-semibold mb-0 {{ $item->is_admin ? "text-success" : "text-danger" }}"
                                        >
                                            {{ $item->is_admin ? "Ya" : "Tidak" }}
                                        </h6>
                                    </td>
                                    <td class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">
                                    ...
                                    >
                                        <a
                                            ...
                                            href="{{ route("konfigurasi-user.edit", $item->id) }}"
                                        >
                                            <i
                                        ...
                                        <form
                                            action="{{ route("konfigurasi-user.destroy", $item->id) }}"
                                            method="post"
                                        >
                                            @csrf
                                            @method("delete")
